...
func main() {
	...
	agentRepo := agent.NewRepository(mysqlDB)
	agentRunner := agent.NewRunner(agentRepo, contextBuilder, agentRegistry, agent.NewDeterministicModelClient())
	agentHandler := agent.NewHandler(agentRegistry, contextBuilder, agentRunner)
	agentProposalService := agent.NewProposalService(agentRepo, dailyTaskService, timerService)
	agentHandler.SetProposalService(agentProposalService)
	...
	api.GET("/agent/runs", agentHandler.ListRuns)
	api.POST("/agent/runs", agentHandler.CreateRun)
	api.GET("/agent/runs/:id", agentHandler.GetRun)
	api.GET("/agent/runs/:id/trajectory", agentHandler.GetRunTrajectory)
	api.GET("/agent/action-proposals", agentHandler.ListActionProposals)
	api.GET("/agent/action-proposals/:id", agentHandler.GetActionProposal)
	api.POST("/agent/action-proposals/:id/accept", agentHandler.AcceptActionProposal)
	api.POST("/agent/action-proposals/:id/reject", agentHandler.RejectActionProposal)
